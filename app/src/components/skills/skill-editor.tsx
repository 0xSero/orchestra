      ...
      {(current) => (
        <div class="flex flex-col h-full">
          <div class="flex items-center justify-between border-b border-border p-4">
            <div>
              <h2 class="text-lg font-semibold text-foreground">{current().id}</h2>
          ...
          <div class="flex gap-2 border-b border-border px-4 py-2 text-xs">
            <button
              class={activeTab() === "basic" ? "text-foreground font-medium" : "text-muted-foreground"}
              onClick={() => setActiveTab("basic")}
            >
              Basic
            </button>
            <button
              class={activeTab() === "prompt" ? "text-foreground font-medium" : "text-muted-foreground"}
              onClick={() => setActiveTab("prompt")}
            >
              Prompt
            </button>
            <button
              class={activeTab() === "tools" ? "text-foreground font-medium" : "text-muted-foreground"}
              onClick={() => setActiveTab("tools")}
            >
              Tools
            </button>
            <button
              class={activeTab() === "permissions" ? "text-foreground font-medium" : "text-muted-foreground"}
